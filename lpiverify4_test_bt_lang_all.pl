...
(international_interpret([lang,"en"],Debug,Query1,Types1,Modes1,Functions1,Result1)->(Score3 is Score1+1,writeln([test_types,NTotal3,passed]));(Score3=Score1,writeln([test_types,NTotal3,failed]))).
...
test_all_bt000(testopen_cases,Debug,NTotal3,Score1,Score3,Lang) :-
	...
	trans_alg1(Functions,"en",Lang,Functions1),
	(Debug=on->writeln1(Functions1);true),
	((international_interpret([lang,"en"],Debug,Query1,Functions1,Result),not(Result=[]))->(Score3 is Score1+1,writeln([testopen,NTotal3,result,Result]),writeln([test,NTotal3,passed]));(Score3=Score1,writeln([testopen,NTotal3,failed]))).
...
((international_interpret([lang,"en"],Debug,Query1,Types1,Modes1,Functions1,Result),not(Result=[]))->(Score3 is Score1+1,writeln([test_open_types,NTotal3,result,Result]),writeln([test_open_types,NTotal3,passed]));(Score3=Score1,writeln([test_open_types,NTotal3,failed]))).
